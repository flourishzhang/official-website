...
<?php require ("phone/head.php");?>
    <div class="w-p-index-box1">
        <img src="<?php AssetsUrl ();?>/img/phone_index/index_box1.png" alt="">
    </div>
    <div class="w-p-index-box2">
        ...
        <div class="w-index-contant">
            <img src="<?php AssetsUrl ();?>/img/phone_index/index_box2.png" alt="">
        </div>
    ...
    <div class="w-p-index-box3">
        <div class="w-index-title">
            <div>
                <img style="margin-right: .5em;" src="<?php AssetsUrl ();?>/img/titleleft.png">
                解决方案
                <img style="margin-left: .5em;" src="<?php AssetsUrl ();?>/img/titleright.png">
            </div>
        </div>
        <div class="w-index-contant clearfix">
            <a href="<?php SiteUrl();?>/mobilegym.html"><img src="<?php AssetsUrl ();?>/img/phone_index/index_box3-1.png" alt=""></a>
            <a href="<?php SiteUrl();?>/mobilecommunity.html"><img src="<?php AssetsUrl ();?>/img/phone_index/index_box3-2.png" alt=""></a>
            <a href="<?php SiteUrl();?>/mobilepowerful.html"><img src="<?php AssetsUrl ();?>/img/phone_index/index_box3-3.png" alt=""></a>
            <a href="<?php SiteUrl();?>/mobileagriculture.html"><img src="<?php AssetsUrl ();?>/img/phone_index/index_box3-4.png" alt=""></a>
            <a href="<?php SiteUrl();?>/mobilecinema.html"><img src="<?php AssetsUrl ();?>/img/phone_index/index_box3-5.png" alt=""></a>
            <a href="<?php SiteUrl();?>/mobilecybercafe.html"><img src="<?php AssetsUrl ();?>/img/phone_index/index_box3-6.png" alt=""></a>
        </div>
    </div>
    <div class="w-p-index-box4">
        ...
        <div class="w-index-contant clearfix" id="w_index_header1">
            ...
            <div class="w-index-right" id="w_index_header2">
                <div>
                    <img class="active2" src="<?php AssetsUrl ();?>/img/phone_index/index_box4_1.png" alt="">
                    <img src="<?php AssetsUrl ();?>/img/phone_index/index_box4_2.png" alt="">
                    <img src="<?php AssetsUrl ();?>/img/phone_index/index_box4_3.png" alt="">
                    <img src="<?php AssetsUrl ();?>/img/phone_index/index_box4_4.png" alt="">
                    <img src="<?php AssetsUrl ();?>/img/phone_index/index_box4_5.png" alt="">
                    <img src="<?php AssetsUrl ();?>/img/phone_index/index_box4_6.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-p-index-box6">
        ...
        <div class="w-index-contant">
            <img src="<?php AssetsUrl ();?>/img/phone_index/index_box6.png" alt="">
        </div>
    </div>
