    ...
    <div class="y-nong-box2">
        ...
        <div class="y-nong-body  clearfix">
            <div class="y-nong-left fromRight">
                <p>
                    智能农业温室大棚，可实时无线采集和传输温室大棚内空气中以及土壤的温度、湿度、光照、PH、 CO2浓度等 环境参数,通过PC电脑、移动手机和平板电脑以直观的图表和曲线的方式显示给用户,可根据种植作物的需求 提供各种声光报警信息,并可以自定义规则控制洒水、 农药以及温度。它主要由农业温室大棚、各种无线传感 话、控制器及后台系统软件和用户端APP等组成。</p>
            </div>
