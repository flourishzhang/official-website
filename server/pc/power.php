    ...
    <div class="y-power-box2">
        ...
        <div class="y-power-body  clearfix">
            <div class="y-power-left  fromRight">
                <p>
                    该系统是基于互联网的数据远程实时传输以及数据远程控制功能开发的。通过网络监控各个设备结点,以分散监控,集中管理的方式有效解决用电单位电气线路老旧、小微企业无专业电工、肉眼无法直观系统即时排查电气隐患、隐蔽工程隐患检查难等难题。
                </p>
                <p>智慧安全用电是从源头，上预防电气火灾的有效措施,本系统可以引导大众牢固树立安全意识、全面落实安全安全用电的基本措施。
                </p>
    ...
    <div class="y-power-box3">
        ...
        <div class="y-power-body2">
            <ul class="clearfix">
                ...
                <li class="fromBottom" style="animation-delay: 0.5s;">
                    <h3> 5.易维护性</h3>
                    <p>系统硬件可以很方便的实现远程管理及维护;系统软件均采用模块化的设计, 并提供友好的人机接口,确保系统的易维护性。
                    </p>
                </li>
                <li class="fromBottom" style="animation-delay: 0.7s;">
                    <h3>6.灵活的扩展性</h3>
        ...
        <ul>
            ...
            <li class="clearfix">
                ...
                <div class="y-power-zi  fromLeft">
                    <h3>2.用户管理系统</h3>
                    <p> 这里的用户指的并不是管理员,而是终端用户,如果针对的是智能电表,那这个终端用户指的就将是每一户的居民,每个用户可以绑定多个智能电表,但是每个智能电表智能绑定-个用户。
                    </p>
                </div>
            </li>
            <li class="clearfix">
            ...
            <li class="clearfix">
                ...
                <div class="y-power-zi  fromLeft">
                    <h3>4.新闻资讯系统</h3>
                    <p> 新闻资讯系统基于B/S模式的WEBMIS系统。本系统可以将杂乱无章的信息(包括文字，图片和影音)经过组织，合理有序地呈现在大家面前。
                    </p>
                </div>
            </li>
            <li class="clearfix">
                <div class="y-power-zi  fromRight">
                    <h3>5.App系统</h3>
                    <p> App系统主要有两个端,一个是维修师傅的那一端,用于在故障现场查看设备参数的。另一个是用户端,用于支付费用,接收报警信息等。
                    </p>
                </div>
                <div class="y-block"></div>
                <div class="y-power-tu fromLeft">
