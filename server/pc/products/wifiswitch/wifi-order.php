...
?>
<div class="y-wifi-order-box3">
    <ul class="clearfix">
        <li>
            <div class="y-order-title">
                <h4>淘宝购买链接</h4>
            </div>
            <div class="y-order-download  clearfix"  style="height:70px;line-height: 70px;">
                <a>
                    <p style="line-height: 70px;"> 这里是链接可点击</p>
                    <span class="iconfont icon-taobao" style="color: #FF5C00;margin-top: -6.5%"> </span>
                </a>
            </div>
        </li>
        <li>
            ...
            <div class="y-order-download  clearfix">
