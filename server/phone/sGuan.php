<?php require ("phone/head.php");?>
    ...
    <div class="y-ph-guan-box2">
        ...
        <div class="y-ph-guan-body2">
            <img src="<?php echo $webmsg["assetsurl"];?>/img/s-guan/guan-index1.png" alt="">
            <p>沃航(武汉)科技有限公司成立于2016年7月,是一家从事软件外包,技术解决方案的互联网科技公司。以精湛的技术、丰富的经验、优质的服务来为客户提供互联网一站式解决方案。</p>
            <p>经营范围为:系统集成;信息技术咨询服务;数据处理;软件开发;设计服务;商标代理服务;知识产权代理服务;广告设计;会议及展览服务;动漫游戏软件在应用开发;翻译服务;工业设计;服务器搬迁维护等。</p>
        </div>
    </div>
    <div class="y-ph-guan-box3">
        ...
        <div class="y-ph-guan-body3 ">
            <ul  class="clearfix">
                ...
                <li>
                    <h5>沃航文化</h5>
                    <p>用最专业的技术，最良好的态度服务客户，用质量铸就品牌。</p>
                </li>
                <li>
                    <h5>沃航使命</h5>
                    <p>用技术推进发展，用专业改变世界。</p>
    ...
    <div class="y-ph-guan-box4">
        ...
        <div class="y-ph-guan-body4">
            <img src="<?php echo $webmsg["assetsurl"];?>/img/s-guan/guan-index2.png" alt="">
        </div>
